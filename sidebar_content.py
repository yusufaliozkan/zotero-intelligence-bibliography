...
def sidebar_content():
    # Expand sidebar on desktop only
    st.markdown("""
        <script>
    ...
    with st.sidebar:
        ...
        with st.expander('Source code'):
            st.info('Source code of this app is available [here](https://github.com/YusufAliOzkan/zotero-intelligence-bibliography).')
        ...
        with st.expander('Sponsors'):
            st.markdown('Proudly sponsored by the [King\'s Centre for the Study of Intelligence](https://kcsi.uk/)')
...
def set_page_config():
    st.set_page_config(
        ...
        initial_sidebar_state="auto"  # ← back to auto
    )
