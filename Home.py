            ...
            with st.expander('Click to expand', expanded=False):
                ...
                if item_monitoring:
                    ...
                    journals_with_filtered_items = [
                        ...
                        'Cambridge Review of International Affairs', 'Public Policy and Administration', 'Armed Forces & Society'
                        ]

                    # Define keywords for filtering
                    keywords = ['intelligence', 'spy', 'counterintelligence', 'espionage', 'role']
