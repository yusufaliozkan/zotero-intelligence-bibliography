    ...
    with tab1:
        ...
        with col1:
            ...
            with st.expander('Click to expand', expanded=False):
                ...
                cumulative_df = pd.DataFrame({'YearMonth': cumulative_counts.index, 'Total items': cumulative_counts})
                ...
                cumulative_chart = alt.Chart(cumulative_df).mark_line().encode(
                    ...
                    y=alt.Y('Total items', title='Total items'),  # Customize the y-axis label
