...
with st.spinner('Retrieving data & updating dashboard...'):
    ...
    with st.sidebar:
        ...
        with st.expander('About'):
            ...
            ''')
            st.write('This website was built and is managed by [Yusuf Ozkan](https://www.kcl.ac.uk/people/yusuf-ali-ozkan) | [Twitter](https://twitter.com/yaliozkan) | [LinkedIn](https://www.linkedin.com/in/yusuf-ali-ozkan/)')
            components.html(
            """
