...
st.title("Counterintelligence", anchor=False)
...
with st.spinner('Retrieving data & updating dashboard...'):
    ...
    df_collections=df_collections[df_collections['Collection_Name'].str.contains("08.")]
    ...
    with col1:
        ...
        radio = container.radio('Select a collection', unique_collections, horizontal=True)
