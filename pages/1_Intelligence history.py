...
with st.spinner('Retrieving data & updating dashboard...'):
    ...
    if selected_collection_name in unique_collections:
        ...
        radio = container.selectbox('Select a collection', unique_collections, index=unique_collections.index(selected_collection_name))
    else:
        radio = container.selectbox('Select a collection', unique_collections)
