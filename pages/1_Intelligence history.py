...
#UNTIL HERE
        with col2:
            ...
            with st.expander('Events', expanded=True):
                ...
                df_gsheet = conn.read(spreadsheet='https://docs.google.com/spreadsheets/d/10ezNUOUpzBayqIMJWuS_zsvwklxP49zlfBWsiJI6aqI/edit#gid=939232836', worksheet='Form Responses 3') 
                df_gsheet
