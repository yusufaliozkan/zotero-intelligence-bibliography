...
with col1:
    ...
    for prog_type in types:
        ...
        with st.expander(f"{prog_type} ({len(type_programs)})"):
            ...
            if prog_type != 'Academic programs':
                if num_unique_countries != 1:
                    if isinstance(prog_type, pd.DataFrame):  # Check if prog_type is a DataFrame
                        ...
                        for index, row in prog_type.iterrows():
                            ...
                            # Assuming display_numbered_list shows a list of programs based on type_programs
            ...
            # Displaying the numbered list outside the loop
            display_numbered_list(type_programs, prog_type, show_country=False if prog_type != 'Academic' else False)
