        ...
        with col1: 
            ...
            # SEARCH IN COLLECTIONS
                ...
                with st.expander('Click to expand', expanded=True):                    
                    ...
                    ''')
                    st.metric(label=f"The number of citations for **{number_of_items}** sources", value=int(citation_count), label_visibility='visible', help='total items measured for citation: {non_nan_id}')     
