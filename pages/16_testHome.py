                            ...
                            for i, article in enumerate(articles_list, start=1):
                                ...
                                if display_abstracts:
                                    ...
                                    if pd.notnull(abstract):
                                        ...
                                        st.markdown(f"<h4>Abstract for article {i}</h4>", unsafe_allow_html=True)
                                        if highlighted_abstract:
                                            st.markdown(f"<small>{highlighted_abstract}</small>", unsafe_allow_html=True)
                                        else:
                                            st.markdown("**Abstract for article {i}**: N/A")
